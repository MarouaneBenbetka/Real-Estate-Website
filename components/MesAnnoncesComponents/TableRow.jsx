    ...
    <>
      ...
      <div className="modal hero lg:min-w-xl" id="my-modal-2">
        <div className="modal-box">
          ...
          <p className="py-4">
            une fois que vous supprimer cette annonce vous ne pourez plus la
            recuperer
          </p>
      ...
      <tr className="bg-white ">
        ...
        <td className="bg-white text-dark-blue">
          ...
          <span className="text-[16px] font-normal pr-1 pl-1">DA</span>
          <span className="text-gray-500 text-[18px]">/ {typePayment}</span>
        </td>
        <td className="bg-white flex gap-6 items-center mt-3">
          ...
          >
            <BiTrash size={26} color="#d92525" className="bg-white"></BiTrash>
          </button>
        </td>
      </tr>
    </>
