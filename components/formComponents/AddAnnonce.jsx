...
const LocationPicker2 = dynamic(
  () =>
    import("../../components/formComponents/ControlComponents/LocationPicker"),
  {
    ssr: false,
  }
);
...
const AddAnnonce = () => {
  ...
  const onSubmit = async (values, onSubmitProps) => {
    ...
    try {
      ...
      console.log(session);
	  const response = await axios.post(`http://192.168.145.12:5000/annonces`, {
		wilaya,
		commune,
		description,
		typeId: 1,
                ...
                <div className="md:grid md:grid-cols-2 md:gap-y-1 md:gap-x-6">
                  ...
                  <FormikControl
                    ...
                    onChange={(e) => {
                      ...
                      setPosition(
                        findLocation(e.target.value, formik.values.wilaya)
                      );
                    ...
                    onFirstRender={(c) => {
                      setPosition(findLocation(c, formik.values.wilaya));
                    }}
                  />
                  <FormikControl
                    control="select"
